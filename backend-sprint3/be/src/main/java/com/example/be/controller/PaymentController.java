...
import com.example.be.model.PayPalLink;
import com.example.be.paypal.PaypalPaymentIntent;
import com.example.be.paypal.PaypalPaymentMethod;
import com.example.be.service.PaypalService;
...
public class PaymentController {
    ...
    private final String URL_PAYPAL_SUCCESS = "http://localhost:4200/client/paypal";
